...
function pouet_scripts() {
 	wp_enqueue_style( 'pouet-styles', get_template_directory_uri() . '/assets/css/styles.css', array(), "", 'screen'  );
 	wp_enqueue_script( 'pouet-scripts', get_template_directory_uri() . '/assets/js/main.js', array(), "", true  );
 }
